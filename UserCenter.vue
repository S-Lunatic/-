  ...
  <div class="user-center">
   ...
   <div class="menu-item" @click="goTo('myTasks')">
      ...
      <!-- <div class="menu-item" @click="goTo('favorites')">
        <span class="menu-icon">⭐</span>
        <span class="menu-text">收藏的视频</span>
        <span class="menu-arrow">›</span>
      </div> -->
      <!-- 在收藏的视频之后或之前添加 -->
...
const submitCertification = () => {
  if (certType.value === 'caregiver') {
    ...
    userStore.submitCertification('caregiver', {
    ...
    userStore.submitCertification('merchant', {
      shopName: certForm.value.shopName,
      license: certForm.value.license,
      address: certForm.value.address,
...
const goTo = (target) => {
  const routes = {
    pets: '/pet-profile',
    orders: '/my-orders',
    myTasks: '/my-published-tasks',  // 新增：我发布的任务
     myVideos: '/my-videos',  // 新增我的视频
    favorites: '/favorites',
